...
echo "new kie version :" $kieVersion
echo "new erraiVersion :" $erraiVersion
echo "new uberfire version :" $uberfireVersion
...
./droolsjbpm-build-bootstrap/script/release/update-version-all.sh $kieVersion $target
